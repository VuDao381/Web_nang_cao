...
<div class="category-form-container">
    ...
    <div class="form-header">
        <div class="header-info">
            <h2><i class="fa-solid fa-building-circle-plus"></i> Thêm Nhà xuất bản mới</h2>
            <p>Đăng ký thông tin đơn vị xuất bản mới vào hệ thống</p>
        </div>
...
<style>
    /* Scoped Styles để không làm ảnh hưởng trang khác */
